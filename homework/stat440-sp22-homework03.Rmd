...
**#1** (Markdown) Using Markdown syntax, make a non-numbered list with your netID in normal text as the first item and full name in normal text as the second item.
